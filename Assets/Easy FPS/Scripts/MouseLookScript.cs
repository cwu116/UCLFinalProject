...
public class MouseLookScript : MonoBehaviour {
	...
	void Awake(){
        ...
        control.Move.Rotation.performed += ctx => rotationVal = ctx.ReadValue<Vector2>();
        control.Move.Rotation.canceled += ctx => rotationVal = Vector2.zero;
    }
...
void MouseInputMovement(){
	...
	wantedYRotation += rotationVal.x * mouseSensitvity * 0.1f;

	wantedCameraXRotation -= rotationVal.y * mouseSensitvity * 0.1f;
